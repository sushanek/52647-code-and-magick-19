...
(function () {
  ...
  window.utils.chooseColor(setupFireballWrap, fireballColors, fireballColorInput);
  ...
  window.utils.chooseColor(setupWizardEyes, eyesColors, eyesColorInput);
  ...
  window.utils.chooseColor(setupWizardCoat, coatColors, coatColorInput);
})();
